    ...
    testthat::test_that("request returns valid response and is parsed to a tibble",{
        ...
        x <-
            c("transaction_key", "transaction_id", "type", "status", "timestamp",
              ...
              "position_source_type", "position_destination_type", "position_destination_team_key",
              "position_destination_team_name", "position_source_team_key",
              "position_source_team_name")
